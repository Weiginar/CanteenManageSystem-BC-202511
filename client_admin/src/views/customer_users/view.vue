		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="顾客姓名" prop="customer_name">
												<el-input id="customer_name" v-model="form_sub['customer_name']" placeholder="请输入顾客姓名"
							  v-if="user_group === '管理员' || (form_sub['customer_users_id'] && $check_field('set','customer_name')) || (!form_sub['customer_users_id'] && $check_field('add','customer_name'))"></el-input>
					<div v-else-if="$check_field('get','customer_name')">{{form_sub['customer_name']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="顾客性别" prop="customer_gender">
								<el-select id="customer_gender" v-model="form_sub['customer_gender']"
						v-if="user_group === '管理员' || (form_sub['customer_users_id'] && $check_field('set','customer_gender')) || (!form_sub['customer_users_id'] && $check_field('add','customer_gender'))">
						<el-option v-for="o in list_customer_gender" :key="o" :label="o" :value="o">
						</el-option>
					</el-select>
					<div v-else-if="$check_field('get','customer_gender')">{{form_sub['customer_gender']}}</div>
							</el-form-item>
			</el-col>
								<el-col v-if="user_group === '管理员' || $check_field('get','customer_age') || $check_field('add','customer_age') || $check_field('set','customer_age')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="顾客年龄" prop="customer_age">
												<el-input id="customer_age" v-model="form_sub['customer_age']" placeholder="请输入顾客年龄"
							  v-if="user_group === '管理员' || (form_sub['customer_users_id'] && $check_field('set','customer_age')) || (!form_sub['customer_users_id'] && $check_field('add','customer_age'))"></el-input>
					<div v-else-if="$check_field('get','customer_age')">{{form_sub['customer_age']}}</div>
											</el-form-item>
			</el-col>
