<template>
	<div class="diy_details page_dish_information" id="dish_information_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_dish_information'>
							<div_dish_information :obj="obj"></div_dish_information>
	...
	export default {
		...
		methods:{
			...
			add_hits(obj) {
				obj["hits"] = obj["hits"] + 1;
				var hits = obj["hits"];
				this.$post('~/api/dish_information/set?dish_information_id=' + obj["dish_information_id"], {
					hits
				}, (res) => {
					if(res.result){
			...
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.dish_information_id;
				}
			},
			/**
			 * 初始化收藏状态
