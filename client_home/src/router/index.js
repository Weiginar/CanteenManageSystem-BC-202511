...
const routes = [
		...
		// 菜品信息详情路由
	{
		...
		component: () => import('../views/dish_information/details.vue')
			...
			// 线下订单添加路由
	{
		path: '/offline_orders/edit',
		name: '/offline_orders_edit',
		component: () => import('../views/offline_orders/edit.vue')
	},
	
	
			// 线上订单添加路由
	{
		path: '/online_orders/edit',
		name: '/online_orders_edit',
		component: () => import('../views/online_orders/edit.vue')
	},
...
router.afterEach((to, from, next) => {
	let title = "餐厅管理系统-home";
	document.title = title;
	document.logo = "餐厅管理系统"
})
